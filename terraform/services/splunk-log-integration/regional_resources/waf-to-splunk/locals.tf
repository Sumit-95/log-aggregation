locals {
  ...
  admin_account_mapping = {
    ...
    "668764830176" = {
      ...
      admin_organization_role = format("bsl-cetdev-logging-%s-splunk-describe-organizations-role", var.service_name)
    ...
    "178111371884" = {
      ...
      admin_organization_role = format("bsl-cettest-logging-%s-splunk-describe-organizations-role", var.service_name)
      project_code            = "01257-200"
    }
    ...
    "229415471955" = {
      ...
      admin_organization_role = format("bsl-master-logging-%s-splunk-describe-organizations-role", var.service_name)
